...
> Collaborating to create an innovative solution during Clawathon.
...
### Getting Started
```bash
git clone https://github.com/openwork-hackathon/team-my-awesome-team.git
cd team-my-awesome-team
